...
(function (w) {
  (w.CV_I18N = w.CV_I18N || {}).fr = {
    ...
    work: { label: "// travaux sélectionnés", h: "Ce que j'ai construit", p: "Des systèmes qui lisent des documents à grande échelle. Ouvrez un projet pour le détail technique.", show: "Voir le détail ▾", hide: "Masquer le détail ▴", deck: "Voir la présentation sur slideshare.net", timelineLink: "Voir sur la frise" },
    ...
    ct: { label: "// contactez moi", h1: "Vous développez une application IA native ?", h2: "", p: "J'aimerais en discuter, écrivez-moi - je suis basé à Valence et peux travailler à distance.", footer: "© 2026 Vincent Rizzo · Valence, Espagne" },
    edu: [
    ...
    languages: [
      { name: "Français", level: "Langue maternelle", flag: "🇫🇷" }, { name: "English", level: "Courant · C2", flag: "🇬🇧" },
      { name: "Español", level: "Courant · C2", flag: "🇪🇸" }, { name: "Català", level: "Conversationnel · B1", flag: "🏴󠁥󠁳󠁣󠁴󠁿" },
    ],
